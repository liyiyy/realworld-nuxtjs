...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/login/index.vue?vue&type=template&id=080befb0&
...
// CONCATENATED MODULE: ./pages/login/index.vue?vue&type=template&id=080befb0&
  ...
  methods: {
    async onSubmit() {
      try {
        ...
        console.log(data);
        this.$store.commit('setUser', data.user); //  为了防止  刷新页面数据丢失，要把数据存在本地 ，持久化
