...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/home/index.vue?vue&type=template&id=1099b59f&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"home-page"},[_vm._ssrNode("<div class=\"banner\"><div class=\"container\"><h1 class=\"logo-font\">home page</h1> <p>A place to share your knowledge.</p></div></div> "),_vm._ssrNode("<div class=\"container page\">","</div>",[_vm._ssrNode("<div class=\"row\">","</div>",[_vm._ssrNode("<div class=\"col-md-9\">","</div>",[_vm._ssrNode("<div class=\"feed-toggle\">","</div>",[_vm._ssrNode("<ul class=\"nav nav-pills outline-active\">","</ul>",[(_vm.user)?_vm._ssrNode("<li class=\"nav-item\">","</li>",[_c('nuxt-link',{staticClass:"nav-link",class:{'active':_vm.tab==='your_feed'},attrs:{"exact":"","to":{
                name:'home',
                query:{
                  tab:'your_feed'
                }
...
// CONCATENATED MODULE: ./pages/home/index.vue?vue&type=template&id=1099b59f&
...
/* harmony default export */ var homevue_type_script_lang_js_ = ({
  ...
  async asyncData({
    ...
    const tab = query.tab || 'global'; // const {data} = await 
    // const {data:tagData}=await 

    const loadArticles = store.state.user && tab === 'your_feed' ? api_article["f" /* getFeedArticles */] : api_article["d" /* getArticles */]; // 优化，并发执行
